...
export default class SelectHelper {
  ...
  onObjectSelected(obj) {
    ...
    if (
      obj.userData &&
      (obj.userData.type === 'text' || obj.userData.type === 'pointMarker')
    ) {
      this.unselect();
      return;
    }
  ...
  onAfterRender() {
    ...
    let renderCamera =
      global.app.editor.view === 'perspective'
        ? global.app.editor.camera
